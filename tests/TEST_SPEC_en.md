...
### 2.2 Frontend Store Logic Tests (`Vitest` - 22 Cases)
...
- **Loading Control:** Verifies the reactive coordination of `isLoading` and `loadingText` state counters during asynchronous operations like file load and save (2 cases).

### 2.3 E2E Tests (`Playwright` - 11 Cases)
